...
class EquiposControllerTest < ActionController::TestCase
  ...
  test "should create equipo" do
    assert_difference('Equipo.count') do
      post :create, equipo: { fabricante: @equipo.fabricante, funcion: @equipo.funcion, modelo: @equipo.modelo }
    end
  ...
  test "should update equipo" do
    patch :update, id: @equipo, equipo: { fabricante: @equipo.fabricante, funcion: @equipo.funcion, modelo: @equipo.modelo }
    assert_redirected_to equipo_path(assigns(:equipo))
  end
